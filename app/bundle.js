...
var toFinite = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__searchElem__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtubeElems__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__swipe__ = __webpack_require__(17);




const searchElem = new __WEBPACK_IMPORTED_MODULE_0__searchElem__["a" /* default */]();
const youtubeElemsObj = new __WEBPACK_IMPORTED_MODULE_1__youtubeElems__["a" /* default */]();
const swipeObj = new __WEBPACK_IMPORTED_MODULE_2__swipe__["a" /* default */]();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__search__ = __webpack_require__(4);
...
class SearchElem {
    ...
    makeRequest() {
        ...
        this.startSpinner();
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__search__["a" /* default */])(this.createUrl())
            .then((response) => {
    ...
    makeRequestNextPage() {
        this.startSpinner();
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__search__["a" /* default */])(this.createUrlNextPage())
            .then((response) => {
                this.searchResultList = JSON.parse(response);
                this.nextPageToken = this.searchResultList.nextPageToken;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SearchElem;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = YoutubeElem;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__search__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtubeElem_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_forEach__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_takeRight__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_takeRight___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash_takeRight__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_chunk__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_chunk___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash_chunk__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_clone__ = __webpack_require__(136);
...
class YoutubeElems {
    ...
    fillYoutubeElemsList(searchResultList) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(searchResultList.items, (value) => {
            this.youtubeElems.push({
                ...
                thumbnails: __WEBPACK_IMPORTED_MODULE_5_lodash_clone___default()(value.snippet.thumbnails)
            });
        });
        this.getStatistics();
    }
    ...
    createUrl() {
        ...
        let videoIdArray = [];
        __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(__WEBPACK_IMPORTED_MODULE_3_lodash_takeRight___default()(this.youtubeElems, 12), (value) => {
    ...
    updateYoutubeElems() {
        ...
        __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(this.statisticsObj.items, (item) => {
            __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(__WEBPACK_IMPORTED_MODULE_3_lodash_takeRight___default()(this.youtubeElems, 12), (elem) => {
    ...
    renderYoutubeElems(slice) {
        ...
        const chunks = __WEBPACK_IMPORTED_MODULE_4_lodash_chunk___default()(this.youtubeElems, slice);
        __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(chunks, (chunk) => {
            let ul = document.createElement('ul');
            __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(chunk, (elem) => {
                const youtubeElem = new __WEBPACK_IMPORTED_MODULE_1__youtubeElem_js__["a" /* default */](
                    elem.videoId,
...
/* harmony export (immutable) */ __webpack_exports__["a"] = YoutubeElems;
;
...
var arrayEach = __webpack_require__(20),
    ...
    castFunction = __webpack_require__(30),
    isArray = __webpack_require__(10);
...
var baseIsArguments = __webpack_require__(25),
    isObjectLike = __webpack_require__(1);
...
var Stack = __webpack_require__(80),
    ...
    assignValue = __webpack_require__(67),
    baseAssign = __webpack_require__(86),
    baseAssignIn = __webpack_require__(87),
...
var DataView = __webpack_require__(75),
    ...
    baseGetTag = __webpack_require__(0),
    toSource = __webpack_require__(72);
...
var cloneArrayBuffer = __webpack_require__(63),
    cloneDataView = __webpack_require__(93),
    cloneMap = __webpack_require__(94),
