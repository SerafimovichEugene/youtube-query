...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__searchElem__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtubeElems__ = __webpack_require__(4);



const searchElem = new __WEBPACK_IMPORTED_MODULE_0__searchElem__["a" /* default */]();
const youtubeElems = new __WEBPACK_IMPORTED_MODULE_1__youtubeElems__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__search__ = __webpack_require__(0);
...
class YoutubeElems {
    ...
    createYoutubeElemsList(searchResultList) {
        __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(searchResultList.items, (value) => {
            this.youtubeElems.push({
                ...
                thumbnails:  __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone(value.snippet.thumbnails)
            });
        });
        this.getStatistics();
    ...
    createUrl() {
        ...
        let videoIdArray = [];
         __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(this.youtubeElems, (value) => {
    ...
    getStatistics() {
         __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__search__["a" /* default */])(this.createUrl())
                .then((response) => {
    ...
    updateYoutubeElems() {
         ...
         __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(this.statisticsObj.items, (item) => {
             __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(this.youtubeElems, (elem) => {
