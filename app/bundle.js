...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__searchElem__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtubeElems__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__swipe__ = __webpack_require__(43);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__youtubeElem_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_forEach__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_takeRight__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_chunk__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_clone__ = __webpack_require__(124);
...
class YoutubeElems {
    ...
    fillYoutubeElemsList(searchResultList) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(searchResultList.items, (value) => {
            this.youtubeElems.push({
                ...
                thumbnails: __WEBPACK_IMPORTED_MODULE_4_lodash_clone___default()(value.snippet.thumbnails)
            });
        });
        this.getStatistics();
    }
    ...
    createUrl() {
        ...
        let videoIdArray = [];
        __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(__WEBPACK_IMPORTED_MODULE_2_lodash_takeRight___default()(this.youtubeElems, 12), (value) => {
    ...
    updateYoutubeElems() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(this.statisticsObj.items, (item) => {
            __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(__WEBPACK_IMPORTED_MODULE_2_lodash_takeRight___default()(this.youtubeElems, 12), (elem) => {
    ...
    renderYoutubeElems(slice) {
        ...
        const chunks = __WEBPACK_IMPORTED_MODULE_3_lodash_chunk___default()(this.youtubeElems, slice);
        __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(chunks, (chunk) => {
            let ul = document.createElement('ul');
            __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(chunk, (elem) => {
                const youtubeElem = new __WEBPACK_IMPORTED_MODULE_0__youtubeElem_js__["a" /* default */](
                    elem.videoId,
...
var Stack = __webpack_require__(51),
    ...
    copySymbolsIn = __webpack_require__(81),
...
var cloneArrayBuffer = __webpack_require__(15);
...
var cloneArrayBuffer = __webpack_require__(15),
    cloneDataView = __webpack_require__(73),
    cloneMap = __webpack_require__(74),
    cloneRegExp = __webpack_require__(75),
    cloneSet = __webpack_require__(76),
